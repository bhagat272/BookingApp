...
import { cilSpeedometer, cilPuzzle, cilCloudDownload, cilUser,cilLayers } from '@coreui/icons';
...
const Dashboard = () => {
  ...
  return (
    <div className="mt-1"> 
    <CSidebar className="border-end" unfoldable colorScheme="dark" style={{height:"100vh"}}>
  ...
  <CSidebarNav>
    ...
    <CNavItem href="#"><CIcon customClassName="nav-icon" icon={cilUser} /> Users</CNavItem>
